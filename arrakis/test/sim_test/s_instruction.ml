...
let test () =
  ...
  Execute.exec 0b0000000_00001_00000_000_01010_0100011l cpu memory;
  Alcotest.check Alcotest.int32 "SB" 30l (Memory.get_byte memory 10l);

  (* SH x1, 10(x0)*)
  Cpu.set_reg cpu 1 0x2303l;
  Execute.exec 0b0000000_00001_00000_001_01010_0100011l cpu memory;
  Alcotest.check Alcotest.int32 "SH" 0x2303l (Memory.get_int16 memory 10l);

  (* SW x1, 15(x0)*)
  Cpu.set_reg cpu 1 0x2343_2303l;
  Execute.exec 0b0000000_00001_00000_010_01111_0100011l cpu memory;
