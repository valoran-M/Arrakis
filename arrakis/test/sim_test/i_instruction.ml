...
let test_arith () =
  ...
  (* SLTIU x1, x2, 4 *)
  Cpu.set_reg cpu 2 (-2l);
  Execute.exec 0b000000000100_00010_011_00001_0010011l cpu memory;
...
let test_load () =
  ...
  Execute.exec 0b000000000101_00010_101_00001_0000011l cpu memory;
  Alcotest.check Alcotest.int32 "LHU 2" (0b1111111111111110l) (Cpu.get_reg cpu 1)

let test_jalr () =
  Cpu.set_pc cpu 0l;
  Cpu.set_reg cpu 1 14l;
  Execute.exec 0b000000000010_00001_000_00010_1100111l cpu memory;
